//
//  WHFoundationExtensionTests.swift
//  WHFoundationExtensionTests
//
//  Created by wangwenhui on 2022/4/14.
//
...
class WHFoundationExtensionTests: XCTestCase {
    ...
    func testDateBasic() throws {
        ...
        guard let date2 = testString2.date(with: DateFormatStyle.ISO) else {
            XCTFail()
            return
        }
        
        let dateStr2 = date2.string(with: DateFormatStyle.ISO)
        XCTAssertEqual(dateStr2, testString2)
        
        let testString3 = "2022-05-06T10:56:51Z"
        guard let date3 = testString3.date(with: DateFormatStyle.ISOShort) else {
            XCTFail()
            return
        }
        
        let dateStr3 = date3.string(with: DateFormatStyle.ISOShort)
